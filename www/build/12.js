...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__course_usershist__ = __webpack_require__(384);
...
var CourseUsersHistPage = /** @class */ (function () {
    ...
    CourseUsersHistPage = CourseUsersHistPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-course_usershist',template:/*ion-inline-start:"D:\DocFam\Proyectos\Consulens\Proyectos\Fedesoft\FullStack\007-GryphusApp\GryphusApp\src\pages\course_usershist\course_usershist.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Historial de Cursos\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <p>Historial_____Prueba de lectura de campo: {{this.usuarioActual.id}} / {{this.usuarioActual.email}} / {{this.usuarioActual.token}}</p>\n\n  <ion-list>\n    <ion-item *ngFor="let curso of cursos">\n      <p>IdRegistro: {{curso.id}}, IDCurso: {{curso.course.nombre}}, NombreCurso: {{curso.course.nombre}}, FechaInicio: {{curso.fechainicio}}, FechaFin: {{curso.fechafin}}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"D:\DocFam\Proyectos\Consulens\Proyectos\Fedesoft\FullStack\007-GryphusApp\GryphusApp\src\pages\course_usershist\course_usershist.html"*/
        }),
